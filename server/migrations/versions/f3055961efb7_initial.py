...
Revision ID: f3055961efb7
Revises: 
Create Date: 2024-01-08 13:41:01.213433
...
def upgrade():
    ...
    sa.Column('login_type', sa.String(), server_default='business', nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('login_type', sa.String(), server_default='user', nullable=True),
    sa.Column('email', sa.String(), nullable=False),
    sa.Column('username', sa.String(), nullable=False),
    sa.Column('_password_hash', sa.String(), nullable=False),
    sa.Column('location', sa.String(), server_default='', nullable=True),
